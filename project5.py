...
calculate_button = tk.Button(root, text="Calculate", font=("Arial", 14), bg="green", fg="white", command=calculate_si)
calculate_button.pack(pady=20)

# Button to clear all fields
clear_button = tk.Button(root, text="Clear", font=("Arial", 14), bg="red", fg="white", command=clear_fields)
